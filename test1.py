...
class Config:
    ...
    TEST_CSV = r"C:\Users\PC\Desktop\visioncontest\Test Set 1\test.csv"
    TEST_IMAGES_FOLDER = r"C:\Users\PC\Desktop\visioncontest\Test Set 1\Test Images"
...
def main():
    ...
    for index, row in test_df.iterrows():
        try:
            ...
            # Update the Winner column with the prediction
            test_df.at[index, 'Winner'] = predicted_winner
    ...
    # Drop the 'Predicted_Winner' column
    test_df = test_df.drop(columns=['Predicted_Winner'])
    
    # Update the CSV file with the modified 'Winner' column
    ...
    print("\nDetailed Breakdown:")
    print(test_df[['Image 1', 'Image 2', 'Winner']])
